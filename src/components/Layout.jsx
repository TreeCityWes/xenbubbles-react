  ...
  return (
    <Container>
      ...
      <Footer>
        <div>
          <SocialIcons>
            <a href="https://youtube.com/treecitywes" target="_blank" rel="noopener noreferrer">
              <img src="https://cdn-icons-png.flaticon.com/512/1384/1384060.png" alt="YouTube" />
            </a>
            <a href="https://twitter.com/treecitywes" target="_blank" rel="noopener noreferrer">
              <img src="https://cdn-icons-png.flaticon.com/512/733/733579.png" alt="Twitter" />
            </a>
            <a href="https://t.me/treecitytrading" target="_blank" rel="noopener noreferrer">
          ...
          <FooterText>© 2024 HashHead.io. All rights reserved.</FooterText>
        </div>
      </Footer>
    </Container>
  );
